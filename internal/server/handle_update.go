...
func (s *Server) handle(ctx context.Context, update *telegram.Update, command string) error {
	...
	case
		...
		s.constants.COMMAND_WORKOUT_PLUS_SET,
		s.constants.COMMAND_WORKOUT_MINUS_SET,
		s.constants.COMMAND_WORKOUT_NEXT_SET,
		s.constants.COMMAND_WORKOUT_PREV_SET,
		s.constants.COMMAND_WORKOUT_PLUS_REPS,
		s.constants.COMMAND_WORKOUT_MINUS_REPS,
		s.constants.COMMAND_WORKOUT_PLUS_1_REP,
		s.constants.COMMAND_WORKOUT_MINUS_1_REP,
		s.constants.COMMAND_WORKOUT_PLUS_5_REPS,
		s.constants.COMMAND_WORKOUT_MINUS_5_REPS,
